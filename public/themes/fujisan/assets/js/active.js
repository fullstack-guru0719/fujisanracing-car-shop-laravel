...
(function($) {
    ...
    jQuery(document).ready(function($) {
        $("select#billing[country]").niceSelect();
        ...
        bgSelector.each(function(index, elem) {
            var element = $(elem),
                ...
                bgOpacity = 1-element.data('bg-opacity');
            element.css('background-image', 'linear-gradient(rgba(0, 0, 0, ' + bgOpacity + '), rgba(0, 0, 0, ' + bgOpacity + ')), url(' + bgSource + ')');
        });
