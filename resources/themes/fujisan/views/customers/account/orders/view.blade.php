                        ...
                        <div class="sale-container">
                            ...
                            <tabs>
                                ...
                                @if ($order->invoices->count())
                                    <tab name="{{ __('shop::app.customer.account.order.view.invoices') }}" class="bottom-first">
                                ...
                                @if ($order->shipments->count())
                                    <tab name="{{ __('shop::app.customer.account.order.view.shipments') }}" class="bottom-second">
                                ...
                                @if ($order->refunds->count())
                                    <tab name="{{ __('shop::app.customer.account.order.view.refunds') }}" class="bottom-third">
