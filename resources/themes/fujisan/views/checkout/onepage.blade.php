                ...
                <div class="cart-page-content-wrap">
                    <div class="container container-wide">
                        <div class="row">
                            <div class="col-main col-lg-6">
                                ...
                                <div class="step-content information" v-show="current_step == 1" id="address-section">
                                    ...
                                    <div class="button-group">
                                        <button type="button" class="btn btn-lg btn-brand" @click="validateForm('address-form')" :disabled="disable_button" id="checkout-address-continue-button">
                                ...
                                <div class="step-content shipping" v-show="current_step == 2" id="shipping-section">
                                    ...
                                    <div class="button-group">
                                        <button type="button" class="btn btn-lg btn-brand" @click="validateForm('shipping-form')" :disabled="disable_button" id="checkout-shipping-continue-button">
                                            {{ __('shop::app.checkout.onepage.continue') }}
                                        </button>
                                ...
                                <div class="step-content payment" v-show="current_step == 3" id="payment-section">
                                    ...
                                    <div class="button-group">
                                        <button type="button" class="btn btn-lg btn-brand" @click="validateForm('payment-form')" :disabled="disable_button" id="checkout-payment-continue-button">
                                            {{ __('shop::app.checkout.onepage.continue') }}
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-right col-lg-6 col-xl-5 ml-auto" v-show="current_step != 4">
                                <summary-section :key="summeryComponentKey"></summary-section>
                            </div>
                        </div>
                    </div>
